...
export const ClientsArchiveView: React.FC<ClientsArchiveViewProps> = ({
  ...
  const handleDeleteClient = (id: string, name: string) => {
    if (confirm(`هل أنت متأكد من حذف ملف العميل (${name}) من الأرشيف؟`)) {
      db.deleteClientArchive(id);
      refreshClients();
      if (selectedClientDossier?.id === id) {
    ...
    filteredClients.forEach((c) => {
      ...
      rowsHtml += `
        <tr>
          ...
          <td>${c.phone || '-'}</td>
          <td>${fin.netFees.toLocaleString()} ج.م</td>
        </tr>
      `;
    });
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-white font-tajawal">
                  أرشيف وسجل ملفات العملاء
                </h1>
                <p className="text-xs md:text-sm text-slate-400">
                  إدارة شاملة لملفات المنشآت والشركات، المواقف الضريبية، السجلات، والخضوع للقيمة المضافة
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            >
              ...
              <span>إضافة عميل جديد للأرشيف</span>
            </button>
              ...
              {filteredClients.length === 0 ? (
                ...
                filteredClients.map((client) => {
                  ...
                  return (
                    ...
                    >
                      {/* Code */}
                      <td className="p-3.5 font-mono text-sky-400 font-bold whitespace-nowrap">
                        {client.clientCode}
                      </td>
                      ...
                      <td className="p-3.5">
                        <button
                          ...
                          className="font-bold text-white hover:text-sky-400 transition-colors text-right block"
                        >
                          {client.name}
                        </button>
                      ...
                      <td className="p-3.5 text-xs">
                        <div className="flex items-center gap-1 text-slate-300 font-mono">
                          ...
                          <strong className="text-emerald-400">
                            {fin.netFees.toLocaleString()} ج.م
                          </strong>
                        </div>
                        <div className="text-[10px] text-slate-500 mt-0.5">
                          وارد: {fin.totalIncome.toLocaleString()} | منصرف: {fin.totalExpenses.toLocaleString()}
                        </div>
                      </td>
                      ...
                      <td className="p-3.5 text-center">
                        <div className="flex items-center justify-center gap-1">
                          <button
                            ...
                            className="p-1.5 hover:bg-slate-800 rounded-lg text-slate-300 hover:text-sky-400 transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 hover:bg-slate-800 rounded-lg text-slate-300 hover:text-amber-400 transition-colors"
                          >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-3xl overflow-hidden shadow-2xl my-8">
            ...
            <form onSubmit={handleSaveClient} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              ...
              <div className="pt-4 border-t border-slate-800 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-6 py-2 bg-sky-600 hover:bg-sky-500 text-white rounded-xl text-xs font-bold shadow-lg shadow-sky-600/20 transition-colors cursor-pointer"
                >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-4xl overflow-hidden shadow-2xl my-6">
            ...
            <div className="p-6 bg-slate-950 border-b border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <h2 className="text-lg md:text-xl font-bold text-white font-tajawal">
                    ...
                    {certs.length === 0 ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                        {certs.map((c) => (
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <span className="font-mono text-sky-400 font-bold">{c.serialNumber}</span>
